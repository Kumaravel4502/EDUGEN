...
const NotFound = () => {
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-[#FFF7FA] mb-20 space-y-10 rounded-xl px-4 py-8 max-w-4xl mx-auto">
                ...
                <p className="text-center text-3xl md:text-4xl text-gray-700 font-semibold">
                ...
                <div className="flex justify-center">
                    <Link to="/">
                        <button className="relative rounded-sm h-[55px] px-8 cursor-pointer mb-1 bg-black text-white transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-[#8A47CB] before:transition-all before:duration-500 hover:text-white hover:before:w-full hover:before:rounded-sm">
