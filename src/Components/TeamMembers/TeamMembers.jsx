...
// const TeamMembers = () => {
//   return (
//     <div className="2xl:container mx-auto mb-50 ">
//       <div className="w-[95%] mx-auto ">
//         {/* Content */}
//         <div className="space-y-3">
//           <p className="sub-titlecontent text-[15px] font-semibold">
//             Team Members
//           </p>
//           <h2 className="text-3xl font-bold max-w-[200px]  leading-10">
//             Our Expert <span className="sub-title ">Lecturer</span>
//           </h2>
//           <div>
//             <p className="w-[190px] text-[11px] font-semibold text-[#878787] leading-5">
//               Lorem Ipsum is simply dummy text of the printing and typesetting
//               industry. Lorem Ipsum has
//             </p>
//             <button
//               className="relative rounded-sm h-[45px] mt-6 mb-1 bg-white px-3 text-black cursor-pointer transition-all before:absolute
...
//                 <div
//                   key={index}
//                   className="bg-white  p-10 border-dashed border-2  border-[#8A47CB] "
//                 >
...
//                   </div>
//                   <div className="flex  justify-between items-center mt-5 hover:cursor-pointer">

//                     <button className="faq-button butt  hover:-translate-y-2  duration-700">
//                       <a href={item.google}>
//                       <svg
//                         xmlns="http://www.w3.org/2000/svg"
//                         viewBox="0 0 24 24"
  ...
  return (
    <div className="2xl:container mx-auto px-4 py-10">
      ...
      <div className="w-[95%] mx-auto text-center mb-10">
        <p className="text-lg font-semibold text-purple-600">Team Members</p>
        <h2 className="text-3xl font-bold leading-10">
          Our Expert <span className="text-purple-600">Lecturers</span>
        </h2>
        <p className="text-gray-600 max-w-md mx-auto mt-2">
          Meet our skilled educators dedicated to providing quality learning
          experiences.
        </p>
      </div>
        ...
        <div className="w-[90%] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3  gap-10">
            {TeamData.map((item, index) => (
              <div
                key={index}
                className="bg-white p-6 border-3 border-dashed border-purple-500 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 w-full sm:w-[80%] md:w-full mx-auto"
              >
                {/* Image */}
                <div className="flex justify-center">
                  <img
                    src={item.image}
                    alt={item.name}
                    className="w-32 h-32 rounded-full object-cover border-2 border-purple-500 p-1 transition-transform duration-500 hover:scale-110"
                  />
                </div>
