...
//             <div className="flex justify-between -mb-8 text-[#555]">
//               <span className="text-2xl font-semibold mb-14">
//                 Skill Mastery Levels
//               </span>
//               <span className="text-2xl font-semibold">80%</span>
//             </div>
//             <div className="w-full bg-gray-200 rounded-full h-2">
//               <div className="Exp h-2 rounded-full" style={{ width: "80%" }} />
//             </div>

//             <div className="flex justify-between -mb-8 mt-5 text-[#555]">
//               <span className="text-2xl font-semibold mb-14">
//                 Learning Milestones
//               </span>
...
//             </div>
//             <div className="w-full bg-gray-200 rounded-full h-2">
//               <div className="Exp h-2 rounded-full" style={{ width: "90%" }} />
//             </div>

//             <div className="flex justify-between -mb-10 text-[#555] mt-5">
//               <span className="text-2xl font-semibold mb-14">
...
//             </div>
//             <div className="w-full bg-gray-200 rounded-full h-2">
//               <div className="Exp h-2 rounded-full" style={{ width: "99%" }} />
//             </div>
//           </div>

//         </div> */}

//         <div className="md:w-5/4 relative">
...
//               <p className="mt-5 mb-10  text-gray-600 text-[16px] font-semibold">
//                 Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore
//                 tempora dolores temporibus neque, voluptas magnam aperiam
//                 dolorem quasi laborum sunt, placeat consectetur.
//               </p>
...
//                 <div className="w-full bg-gray-200 rounded-full h-2">
//                   <div
//                     className="Exp h-2 rounded-full"
//                     style={{ width: "80%" }}
//                   />
//                 </div>
...
//       <img
//         src="https://demo.themeies.com/edugen/wp-content/uploads/2024/09/choose-image-shape.svg"
