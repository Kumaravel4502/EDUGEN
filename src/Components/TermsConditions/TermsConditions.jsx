...
const TermsConditions = () => {
    return (
        <div className="2xl:container mx-auto px-4 sm:px-6 lg:px-8 -mt-8 mb-10">
            ...
            <div className="w-[90%] mx-auto mt-8 space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside text-gray-700 font-medium leading-8 space-y-2">
                ...
                <div className="space-y-4">
                    ...
                    <ul className="list-disc list-inside text-gray-700 font-medium leading-8 space-y-2">
